      ...
      <div>
        <Jumbotron style={{ margin: "10%", backgroundColor: "#073763" }}>
          ...
          <p style={{ color: "white" }}>
            ...
            ethical growth in communities in crisis and social systems
          ...
          <p style={{ color: "white" }}>
            ...
            position with the Director of Psychology, Milton Steinberg, in which
            we develo9ped an interactive website mapping the brain and it’s
            function for the educational and research use of brain injury
          ...
          <p style={{ color: "white" }}>
            ...
            decided to further explore my interest in Psychology by taking a
            non-matriculating graduate course at the Rose Hill campus of Fordham
            University in Bronx, New York. This was an extremely exciting
            experience for me. It was during this time that I developed a great
            respect for graduate study and my enthusiasm for the field increased
            immensely. The most adventurous aspect of this experience was
          ...
          <p style={{ color: "white" }}>
            ...
            customer service and hospitality skills as a youth while working in
            the restaurant industry. As I grew older my thirst for knowledge
            lead me to seek employment in more mentally stimulating environments
            such as Corporate America. In this demanding field, I learned
          ...
          <p style={{ color: "white" }}>
            ...
            intervention counselors. At the Children’s Village I started off as
            a Psychiatric Technician and due to my dedication and love for
          ...
          <p style={{ color: "white" }}>
            ...
            PowerPoint presentations and interpersonal relationship skills to
            attain clients in my community. As the President of the company, I
            developed contractual agreements and managed all business
            transactions between my company, Sweet Scentsations, and my clients.
            I have had some very exciting work adventures, which have allowed me
          ...
          <p style={{ color: "white" }}>
            ...
            passionate spirit, I am also a highly motivated person who seeks an
            understanding of my environment and the human mind. I am a hard
          ...
          <p style={{ color: "white" }}>
            ...
            Affordable & Quality Healthcare (CAQH) Inland Empire California
            Association of Marriage & Family Therapist (ICAMFT) Mental Health
            Steering Act Committee, Cultural Competency (MHSA) National
            Association for the Advancement of Colored People (NAACP) National
            Council Negro Women, Board Member (NCNW) Delta Sigma Theta Sorority,
            Incorporated National Association of Professional Women
          </p>
          <p></p>
        </Jumbotron>
      </div>
